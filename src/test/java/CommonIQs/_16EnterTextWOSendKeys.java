...
public class _16EnterTextWOSendKeys {
    @Test
    public void enterTextWithoutSendKeys() {
        ...
        JS.executeScript("document.getElementById('twotabsearchtextbox').value='Ne istersen'");
    ...
    public void enterTextWithOutSendKeys2() {
        ...
        //JS.executeScript("document.getElementByName('search_query').value='I love Aras'");
